...
[::b]Queue panel[-:-:-]
  ...
  h / l          scroll the columns left / right. Title, Album and
                 Artist are pinned and never move; everything from
  ...
  w              the story behind the track, as a card: the cover on the
                 left, the story, credits, bootlegs and attribution on
                 the right. Read from a wiki/ folder beside the audio --
                 mpdtui never goes online; the stories are gathered
                 ahead of time by music-tui's wiki-fetch and copied in
                 by wiki-push. The picture is drawn as real pixels on a
                 Kitty terminal and as colored half-blocks everywhere
                 else. j/k scrolls, w or Esc closes, transport keys stay
                 live
